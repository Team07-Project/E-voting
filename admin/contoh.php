...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../assets/font-awesome/css/font/css/all.min.css">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><img src="../images/almadani.png" height="40"/></span>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs"><i class="fas fa-user"></i>  Administrator</span> &nbsp;<i class="fa fa-caret-down"></i>
                </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if (!isset($_GET['page'])) { echo 'class="active"'; } ?>>
                <a href="./" ><i class="fas fa-tachometer-alt" > </i> <span style="margin-left: 5px;"> Dashboard</span></a>
            </li>
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kandidat') { echo 'class="active"'; } ?>>
                <a href="?page=kandidat"><i class="fa fa-user"></i> <span>Manajemen Kandidat</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kelas') { echo 'class="active"'; } ?>>
                <a href="?page=kelas"><i class="fas fa-school"></i> <span style="margin-left: 5px;">Manajemen Kelas</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'perolehan') { echo 'class="active"'; } ?>>
                <a href="?page=perolehan"><i class="fas fa-chart-bar"></i> <span  style="margin-left: 8px;">Perolehan</span></a>
            </li>
          </ul>
        </section>
        <!-- /.sidebar -->
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2020 <a href="">RPL SMK AL-MADANI GARUT</a>.</strong> All rights reserved. Powered by : <a href="">REKAYASA PERANGKAT LUNAK</a>
      </footer>
